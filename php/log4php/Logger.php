...
/**
 * This is the central class in the log4php package. All log4php operations
 * are done through this class.
 * 
 * The main log4php methods are:
 * 	<ul>
 * 		<li>{@link trace()}</li>
 * 		<li>{@link debug()}</li>
 * 		<li>{@link info()}</li>
...
class Logger {
	...
	/**
	 * Log a message using the provided log4php level.
	 *
	 * @param LoggerLevel $level The log4php level.
	 * @param mixed $message Message to log.
 	 * @param Exception $throwable Optional throwable information to include 
	 *   in the log4php event.
	 */
	...
	/**
	 * This method creates a new log4php event and logs the event without
	 * further checks.
	 *
